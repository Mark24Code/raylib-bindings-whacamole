...
module RbConfig
  RUBY_VERSION.start_with?("3.3.") or
    raise "ruby lib version (3.3.1) doesn't match executable version (#{RUBY_VERSION})"
  ...
  CONFIG["MINOR"] = "3"
  CONFIG["TEENY"] = "1"
  CONFIG["PATCHLEVEL"] = "55"
  CONFIG["INSTALL"] = '/usr/bin/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/Cellar/portable-ruby/3.3.1")
  ...
  CONFIG["configure_args"] = " '--build=x86_64-apple-darwin21.6.0' '--host=x86_64-apple-darwin15.0.0' '--prefix=/usr/local/Cellar/portable-ruby/3.3.1' '--enable-load-relative' '--with-static-linked-ext' '--without-ext=win32,win32ole' '--without-gmp' '--disable-install-doc' '--disable-install-rdoc' '--disable-dependency-tracking' '--with-libyaml-dir=/usr/local/opt/portable-libyaml' 'build_alias=x86_64-apple-darwin21.6.0' 'host_alias=x86_64-apple-darwin15.0.0' 'CC=clang' 'CXX=clang++' 'LDFLAGS=-Wl,-search_paths_first'"
  ...
  CONFIG["OBJCOPY"] = ":"
  CONFIG["NM"] = "/Library/Developer/CommandLineTools/usr/bin/nm --no-llvm-bc"
  CONFIG["LD"] = "ld"
  CONFIG["CXX"] = "clang++"
  CONFIG["AS"] = "as"
